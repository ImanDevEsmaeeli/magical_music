        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Center(
                child: Text("${widget.mode.name} ${_tools.category}"),
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: TextField(
                ...
                onChanged: (desc) {
                  widget.musicItem.description = desc;
                },
              ),
            ),
            Padding(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: (_isMusicfileSelected)
                      ? () {
                          switch (widget.mode) {
                            case CrudMode.add:
                              widget.musicItem.musicCategory = _tools.category;
                              widget.musicItem.id = Uuid().v1();
                              _music.add(widget.musicItem);
                              break;
                            case CrudMode.edit:
                              _music.edit(widget.musicItem);
                              break;
                            default:
                          }
                        }
